...
v0.8 版本线仍然保持聚焦：不做完整 CRM，不做复杂工单系统，也不复制 Chatwoot、Tiledesk 或 Zammad。OpenSupportAI 专注于 AI 客服运行时，可以从不同渠道接收消息，索引客服知识库，生成基于知识库的回答，并把会话转交给这些客服系统。
